...
public class NotificationServiceContact extends Service {
   ...
   // private String SUBTEXT = "SubText";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        notificationContactRef = database.getReference("notificationContact");

        // Set listener on the Reference
        notificationContactRef.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void sendNotification(String nom, String sujet) {
        ...
        Intent intent = new Intent(getApplicationContext(), ContactAdmin.class);
