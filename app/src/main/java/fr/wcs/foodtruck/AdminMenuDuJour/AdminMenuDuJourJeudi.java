...
public class AdminMenuDuJourJeudi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_menu_du_jour_jeudi);
        ...
        mDbRef = mFire.getReference("MajPlatDuJourJeudi");
