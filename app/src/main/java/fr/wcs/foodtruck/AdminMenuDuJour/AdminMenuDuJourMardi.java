...
import fr.wcs.foodtruck.R;
    ...
    public class AdminMenuDuJourMardi extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_admin_menu_du_jour_mardi);
            ...
            mDbRef = mFire.getReference("MajPlatDuJourMardi");
