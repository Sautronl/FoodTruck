...
public class AdapterListeJour extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
      ...
      /*  inflater = (LayoutInflater)activity.getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View itemView = inflater.inflate(R.layout.activity_liste_adapt,null);
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(activity).inflate(R.layout.activity_liste_adapt,parent, false);
